...
//         setFilteredProjects(result.item); // Initialize filtered data
//       } catch (error) {
...
//     {
//       name: "Project ID",
//       selector: (row) => row.project.projectID,
//       sortable: true,
//     },
//     {
//       name: "Project Name",
...
//     {
//       name: "Start Date",
//       selector: (row) => row.project.startDate,
//       sortable: true,
//     },
//     {
//       name: "Deadline",
//       selector: (row) => row.project.endDate,
//       sortable: true,
//     },
//   ];
...
//               onRowClicked={(row, e) =>
//                 viewClickfunction(e, row.index, row.project.id)
//               }
//             />
//           </div>
//         </div>
